...
.CHANGELOG
    ...
    0.1.9 Optimization and more bugfixes
          ...
          Added '$global:ncxml<vendor>' variables for assigning static 'fallback' sources for AV Product XMLs; XMLs should be uploaded to NC Script Repository and URLs updated (Begin Ln166)
...
#REGION ----- FUNCTIONS ----
  ...
  function Get-AVXML {                                                                              #RETRIEVE AV VENDOR XML FROM GITHUB
    ...
    $global:diag += "Loading : '$($src)' AV Product XML`r`n"
...
if (-not ($global:blnAVXML)) {
  ...
  Rmm-Alert -Category "AV Health : $($i_PAV) : Warning" -Body "$($global:diag)"
...
$global:diag += "`r`nDevice Info :`r`nDevice : $($global:computername)`r`n"
$global:diag += "Operating System : $($global:OSCaption) ($($global:OSVersion))`r`n"
#AV DETAILS
...
$global:diag += "`r`nComponent Versions :`r`n$($o_compver)`r`n"
#REAL-TIME SCANNING & DEFINITIONS
write-host "Definitions :" -foregroundcolor yellow
write-host "Status : $($global:o_DefStatus)" -foregroundcolor $ccode
$global:diag += "`r`nDefinitions :`r`nStatus : $($global:o_DefStatus)`r`n"
#THREATS
...
$global:diag += "`r`nCompetitor AV :`r`nAV Conflict : $($global:o_AVcon)`r`n$($global:o_CompAV)"
$global:diag += "`r`nCompetitor Path :`r`n$($global:o_CompPath)`r`nCompetitor State :`r`n$($global:o_CompState)"
#SYNCRO OUTPUT
if ($global:blnWARN) {
  # This creates an alert in Syncro and triggers the "New RMM Alert" in the Notification Center - automatically de-duping per asset.
  Rmm-Alert -Category "AV Health : $($i_PAV) : Warning" -Body "$($global:diag)"
  ...
  Log-Activity -Message "AV Health : $($i_PAV) : Healthy" -EventName "$($global:diag)"
}
#END SCRIPT
#------------