  ...
  function logERR ($intSTG, $strModule, $strErr) {
    ...
    switch ($intSTG) {
      1 {                                                         #'ERRRET'=1 - NOT ENOUGH ARGUMENTS, END SCRIPT
        ...
        write-output "$($strLineSeparator)`r`n$($(get-date)) - IPERF_Monitor - NO ARGUMENTS PASSED, END SCRIPT`r`n`r`n" -foregroundcolor red
      }
      2 {                                                         #'ERRRET'=2 - END SCRIPT
        ...
        write-output "$($strLineSeparator)`r`n$($(get-date)) - IPERF_Monitor - ($($strModule)) :" -foregroundcolor red
      ...
      3 {                                                         #'ERRRET'=3
        ...
        write-output "$($strLineSeparator)`r`n$($(get-date)) - IPERF_Monitor - $($strModule) :" -foregroundcolor yellow
