  ...
  function logERR ($intSTG, $strModule, $strErr) {
    ...
    switch ($intSTG) {
      1 {                                                         #'ERRRET'=1 - NOT ENOUGH ARGUMENTS, END SCRIPT
        ...
        write-output "$($strLineSeparator)`r`n$($(get-date)) - CW_Control - NO ARGUMENTS PASSED, END SCRIPT`r`n"
      }
      2 {                                                         #'ERRRET'=2 - END SCRIPT
        ...
        write-output "$($strLineSeparator)`r`n$($(get-date)) - CW_Control - ($($strModule)) :"
