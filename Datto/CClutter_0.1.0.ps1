...
$script:diag += "$($strLineSeparator)`r`n$((Get-Date).ToString('dd-MM-yyyy hh:mm:ss')) - EXECUTING CCLUTTER`r`n$($strLineSeparator)`r`n"
write-host "$($strLineSeparator)`r`n$((Get-Date).ToString('dd-MM-yyyy hh:mm:ss')) - EXECUTING CCLUTTER`r`n$($strLineSeparator)"
